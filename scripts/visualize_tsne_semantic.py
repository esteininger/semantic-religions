#!/usr/bin/env python3
"""
Create t-SNE visualization with SEMANTIC CHUNKING for good vs evil classification.
...
def main():
    ...
    ap.add_argument("--out", default="tsne_semantic_visualization.png",
    ...
    print("\n" + "="*70)
    print("GOOD vs EVIL ANALYSIS (Semantic Chunking)")
    print("="*70)
    ...
    for corpus_name in corpora.keys():
        ...
        # Plot good chunks with filled circles
